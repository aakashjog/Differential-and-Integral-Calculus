...
\begin{solution}
	\begin{align*}
		\iint\limits_{S} \overline{F} \cdot \hat{n} \dif S & = \iiint\limits_{E} \divergence \overline{F} \dif V                                          \\
                                                                   ...
                                                                   & = \frac{3}{2} \int\limits_{-1}^{1} \left. -\frac{(2 - z)^3}{3} \right|_{z = 0}^{z = 1 - x^2} \\
                                                                   & = \frac{3}{2} \int\limits_{-1}^{1} \left( \frac{8}{3} - \frac{(1 - x^2)^3}{3} \right) \dif x \\
                                                                   & = \frac{1}{2} \int\limits_{-1}^{1} \left( 8 - (1 + x^2)^3 \right) \dif x                     \\
                                                                   & = \int\limits_{0}^{1} \left( 8 - (1 + x^2)^3 \right) \dif x                                  \\
                                                                   & = \frac{184}{35}
	\end{align*}
\end{solution}
